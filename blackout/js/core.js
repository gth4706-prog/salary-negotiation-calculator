...
BO.Core = (function () {
  ...
  var C = {
    ...
    //  ── 시야각 ─────────────────────────────────────────────────────────────
    //  바라보는 방향(마지막으로 움직인 방향)으로 부채꼴이 열린다. 앞으로 1·2·3칸,
    //  각 거리에서 좌우로 CONE[d-1] 칸씩. 가구 뒤는 안 보인다(LOS). 자기 칸은 늘 보인다.
    //  옆·뒤는 안 보인다 — 그래서 옆으로 갈 땐 **부딪힐 수 있다**(bump: 행동력 1,
    //  그쪽을 보게 되고 그 칸이 뭔지 알게 된다). 더듬더듬 걷는 어둠의 값이다.
    CONE: [1, 1, 2],
