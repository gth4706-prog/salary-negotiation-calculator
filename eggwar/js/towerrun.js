...
GAME.TowerRun = {
  ...
  //  ⚠ 아이템 사다리(js/towershopitems.js)가 이 곡선에 묶여 있다. 누적 실측:
  //    10층 140 · 20층 477 · 30층 1,245 · 40층 3,162 · 60층 24,048.
  //    → 4단계(380)는 20층대, 5단계(1,400)는 30층대, 6단계(4,800)는 40층 후반,
  //      7단계(15,000)는 50층대. 예전보다 한 구간씩 늦어지는데, **난이도가 성장을
  //      따라오므로**(js/tower.js hpMul/dmgMul) 적이 같이 약해져 자기 보정된다.
