...
(function(){
  ...
  var JOBS=[["개발·IT",3400,250,625],["디자인",3000,190,625],["기획·PM",3200,240,625],["마케팅·광고",3050,210,625],
    ["영업·영업관리",3100,230,257],["무역·해외영업",3200,220,257],["인사·HR",3050,200,502],["총무·경영지원",2950,170,502],
    ["회계·세무·재무",3200,215,502],["금융·보험",3500,300,502],["법률·법무",3800,340,625],["연구·R&D",3500,260,625],
    ["생산·제조",2950,175,280],["품질·안전·환경",3050,190,625],["물류·유통·구매",2950,180,502],["건설·건축·토목",3200,230,231],
    ["의료·보건",3400,240,625],["교육",2900,180,625],["미디어·콘텐츠",2900,200,625],["고객상담·CS",2700,140,502],
    ["공공·행정",3000,160,502],["서비스(요식·뷰티 등)",2600,130,347]];
  var sel=$("job");
  ...
  function setPct(top,markerId,rankId){
    ...
    if(r){
      ...
      r.innerHTML=headcount
        ?"같은 직업 대분류 종사자 약 <b>"+headcount+"만 명</b> 중 상위 <b>"+top+"%</b>대(근사치)"
        :"비슷한 조건 100명 중 약 <b>"+top+"등</b>";
    }
  }
