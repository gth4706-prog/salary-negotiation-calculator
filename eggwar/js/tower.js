...
GAME.Tower = {
  ...
  //  ⚠ 2026-09-10 보스 단독 전환 보정(×1.12) 포함 — 위 `BOSS_ESCORT` 주석 참조.
  //    2.4 → 2.68 · 1.65 → 1.84.
  BOSS_HP_PREMIUM: 2.68,
  BOSS_DMG_PREMIUM: 1.84,
  ...
  //    재니 위협의 7~25%(중앙값 ×1.24)였고, 위협 ≈ ehp × dps 라 두 축에 각각
  //    √1.24 ≈ ×1.12 를 얹었다(아래 BOSS_*_PREMIUM). 총 위협은 그대로 두고
  //    **출처만 호위에서 보스로 옮긴 것**이다.
