...
(function () {
  ...
  var DATA = {
    ...
    helmVanguard: { src: 'assets/helm/vanguard2.png?v=2.35' },
    helmPot:    { src: 'assets/helm/pot.png?v=2.35' },
    helmBand:   { src: 'assets/helm/band.png?v=2.35' },
    helmCap:    { src: 'assets/helm/cap.png?v=2.35' },
    helmHood:   { src: 'assets/helm/hood.png?v=2.35' },
    helmLeaf:   { src: 'assets/helm/leaf.png?v=2.35' },
    helmBucket: { src: 'assets/helm/bucket.png?v=2.35' },
    helmHorns:  { src: 'assets/helm/horns.png?v=2.35' },
    helmSedge:  { src: 'assets/helm/sedge.png?v=2.35' },
    helmPot2:   { src: 'assets/helm/pot2.png?v=2.35' },
    helmRanger:   { src: 'assets/helm/ranger.png?v=2.35' },
