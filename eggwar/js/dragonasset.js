...
(function () {
  ...
  //    다섯 부위 전부 `js/bossart.js` 의 벡터(`wingPart`/`halfFacePart`/
  //    `wakingPart` 등)로 옮겼다. **여기 남는 것은 300층 본체 하나뿐**이고,
  //    그건 원본 그림을 통째로(1000×605 전체) 쓰기 때문에 잘린 곳이 없다 —
  //    사용자가 "태초의 용 전체 모습은 변함없이 진행"이라고 지시한 그대로다.
  DA.PARTS = {
