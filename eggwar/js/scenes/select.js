...
GAME.SelectScene.prototype.create = function () {
  ...
  GAME.UI.label(this, W / 2, P ? 26 : 46, '도전할 진형 선택', P ? 22 : 32, C.text, 0.5);
  GAME.UI.label(this, W / 2, P ? 58 : 90,
    'AI 진형은 솔직히 표시합니다. 예산은 상대와 동일합니다.', P ? 12 : 15, C.textDim, 0.5)
  ...
  }, { fill: 0x2a2440, line: 0x9b8cf0, hover: 0x372f52, color: C.accentAlt, fontSize: P ? 15 : 17 });
...
GAME.SelectScene.prototype._row = function (formation, x, y, w, h) {
  ...
  GAME.UI.label(this, x + w - 14, y + (P ? 14 : 20), GAME.UI.winRateText(formation.id),
    P ? 11 : 15, C.warn, 1).setOrigin(1, 0);
  GAME.UI.label(this, x + w - 14, y + (P ? 40 : 46), '도전 →', P ? 11 : 13, C.textDim, 1).setOrigin(1, 0);
};
