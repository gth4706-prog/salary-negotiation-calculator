...
(function () {
  ...
  // ───────────────────────────────────────────────────────────────────────
  var SCALE = {
    display:  [40, 52],   // 세로 37.1px  — EGG WAR 로고, 승/패 판정
    title:    [26, 34],   //       24.1px — 씬 제목
    heading:  [20, 24],   //       18.6px — 구역 제목, 강조 수치
    subhead:  [17, 20],   //       15.8px — 카드 제목, 기본 버튼 라벨
    body:     [15, 17],   //       13.9px — 본문 기본값
    caption:  [13, 14],   //       12.1px — 설명·부연
    micro:    [12, 13],   //       11.1px — 표 머리글, 단위. **이보다 작게 쓰지 않는다**
    button:   [17, 20],   //       15.8px — 주요 버튼
    buttonSm: [15, 16],   //       13.9px — 보조 버튼
    numLg:    [27, 32],   //       25.1px — 전투 타이머
    num:      [20, 24],   //       18.6px — 쿨다운, 점수
    numSm:    [15, 17]    //       13.9px — 표 안 숫자
  };
